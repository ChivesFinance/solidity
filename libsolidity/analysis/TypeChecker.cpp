...
bool TypeChecker::visit(MemberAccess const& _memberAccess)
{
	...
	if (auto funType = dynamic_cast<FunctionType const*>(annotation.type))
	{
		...
		if (!funType->bound())
			annotation.requiresVirtualLookup = !!dynamic_cast<ContractType const*>(exprType);
	}
...
bool TypeChecker::visit(Identifier const& _identifier)
{
	...
	annotation.requiresVirtualLookup = !!dynamic_cast<CallableDeclaration const*>(annotation.referencedDeclaration);
